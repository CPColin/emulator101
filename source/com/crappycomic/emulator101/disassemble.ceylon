...
[String, String?] mnemonicAndArguments(Opcode opcode)
        => switch (opcode)
            ...
            case (incrementPairStackPointer) ["INX", "SP"]
            case (input) ["IN", "#"]
            case (jump) ["JMP", "$"]
            case (jumpIfCarry) ["JC", "$"]
            case (jumpIfMinus) ["JM", "$"]
            ...
            case (loadProgramCounter) ["PCHL", null]
            case (loadStackPointer) ["SPHL", null]
